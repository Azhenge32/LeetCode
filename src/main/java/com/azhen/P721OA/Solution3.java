...
public class Solution3 {
    ...
    public List<List<String>> accountsMerge(List<List<String>> accounts) {
       ...
       for (List<String> list : accounts) {
        ...
        for (Map.Entry<Integer, Set<String>> entry : treeMap.entrySet()) {
            ...
            list.add(0, personList.get(count));
            results.add(list);
            count ++;
        }
        return results;
    ...
    public static void main(String[] args) {
        List<String> list = Arrays.asList("Isa100@m.co","Isa11@m.co","Isa13@m.co","Isa14@m.co","Isa15@m.co","Isa16@m.co","Isa17@m.co","Isa1@m.co", "Isa0@m.co", "Isa10@m.co");
        ...
        // System.out.println("Isa100@m.co".compareTo("Isa1@m.co"));
    }
}
