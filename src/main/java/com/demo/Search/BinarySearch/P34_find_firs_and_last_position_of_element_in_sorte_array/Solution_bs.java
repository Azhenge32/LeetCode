package com.demo.Search.BinarySearch.P34_find_firs_and_last_position_of_element_in_sorte_array;
...
public class Solution_bs {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(res[0] + " : " + res[1]); // 3, 6
        res = solution.searchRange(new int[]{5,7,7,8,8,10}, 6);
        System.out.println(res[0] + " : " + res[1]);
        res = solution.searchRange(new int[]{2, 2}, 3);
        System.out.println(res[0] + " : " + res[1]);
        res = solution.searchRange(new int[]{2, 2}, 2);
        System.out.println(res[0] + " : " + res[1]);
    }
}
